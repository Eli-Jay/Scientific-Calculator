...
long double post_fix_exp_solver(std::vector<std::string> stack_1);
...
long double brent_method(std::string equ, char var, long double a, long double b);
std::vector<long double> equ_solver(std::string equ, char var, long double a, long double b);
